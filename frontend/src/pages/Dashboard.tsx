...
export default function Dashboard() {
  const { user, profile, simulationResults, products, setActiveTab } = useAppStore()
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { icon: Shield, label: 'Products matched', value: products.length, sub: 'across 5 categories', color: 'text-green-600' },
